class CatsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cat.save
        format.html { redirect_to cat_url(@cat), notice: "ねこを登録しました。" }
  ...
  def update
    respond_to do |format|
      if @cat.update(cat_params)
        format.html { redirect_to cat_url(@cat), notice: "ねこを更新しました。" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cats_url, notice: "ねこを削除しました。" }
